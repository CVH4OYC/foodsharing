  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-md p-6 bg-white rounded-xl shadow-lg">
        <h2 className="text-2xl font-bold text-center mb-6 text-primary">Регистрация</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="relative group">
            <label className="block mb-2 text-sm font-medium text-gray-700">Фото профиля</label>
          ...
          <button
            type="submit"
            className="w-full bg-primary text-white py-2 rounded-xl hover:opacity-90 transition-all disabled:opacity-50"
            disabled={isLoading}
          >
