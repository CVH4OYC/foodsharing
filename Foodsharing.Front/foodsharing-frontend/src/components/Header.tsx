        ...
        {isMenuOpen && (
          ...
          >
            <div className="pt-2 space-y-4">
              {isAuth ? (
                <>
                  <Link to="/chats" className="block hover:text-primary">
                    Чаты
                  </Link>
                  <Link to="/favorites" className="block hover:text-primary">
                    Избранное
                  </Link>
                ...
                <>
                  <Link to="/ads" className="block hover:text-primary">
                    Объявления
                  </Link>
                  <Link to="/business" className="block hover:text-primary">
                    Бизнесу
                  </Link>
