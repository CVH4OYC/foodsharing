...
namespace Foodsharing.API.Migrations
{
    ...
    [Migration("20250601081728_AddGeolocationInProfile")]
    partial class AddGeolocationInProfile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Foodsharing.API.Models.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Foodsharing.API.Models.NotificationStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Foodsharing.API.Models.NotificationType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Code = "AnnouncementBooked",
                            Name = "Ваше объявление было забронировано"
                        },
                        new
                        {
                            Id = new Guid("35ca4edf-1ad6-4a22-a2ee-33f538e65647"),
                            Code = "FavoriteCategory",
                            Name = "Новое объявление из любимой категории"
                        },
                        new
                        {
                            Id = new Guid("7227a6af-d5dc-46a6-aed6-8fc0159bcb69"),
                            Code = "NearbyAnnouncement",
                            Name = "Новое объявление рядом"
                        });
                });
            ...
            modelBuilder.Entity("Foodsharing.API.Models.Notification", b =>
                {
                    ...
                    b.HasOne("Foodsharing.API.Models.NotificationStatus", "NotificationStatus")
                        .WithMany("Notifications")
                        .HasForeignKey("NotificationStatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Foodsharing.API.Models.NotificationType", "NotificationType")
                        .WithMany("Notifications")
